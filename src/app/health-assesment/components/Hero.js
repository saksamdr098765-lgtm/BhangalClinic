    ...
    <section className="relative overflow-hidden bg-slate-50 pt-24 pb-14 sm:pt-28 sm:pb-16 lg:pt-36 lg:pb-24">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        <div className="max-w-4xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 rounded-full border border-blue-100 bg-white px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-blue-700 shadow-sm sm:text-xs">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition duration-300 hover:-translate-y-1"
                >
          ...
          {/* Disclaimer */}
          <div className="mt-8 rounded-2xl border border-amber-200 bg-amber-50 p-5 sm:mt-10 sm:p-6">
