  ...
  return (
    <section className="bg-white py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="mt-10 grid gap-5 sm:mt-14 sm:gap-6 md:grid-cols-2 xl:grid-cols-3">
          {pkg?.recommendedFor?.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="group rounded-3xl border border-slate-200 bg-white p-5 transition-all duration-300 sm:p-7 hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-50 transition sm:h-14 sm:w-14 group-hover:bg-blue-100">
        ...
        {/* Bottom Note */}
        <div className="mt-10 rounded-3xl border border-blue-100 bg-gradient-to-r from-blue-50 to-cyan-50 p-6 sm:mt-16 sm:p-10">
