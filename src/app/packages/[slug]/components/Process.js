    ...
    <section className="bg-white py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <span className="inline-flex rounded-full border border-blue-100 bg-blue-50 px-4 py-2 text-xs font-semibold text-blue-700 sm:text-sm">
        ...
        {/* Steps */}
        <div className="relative mt-12 grid gap-5 sm:mt-16 lg:grid-cols-4 lg:gap-6">
            ...
            return (
              <div key={step.title} className="relative">
                ...
                {index !== steps.length - 1 && (
                  <div className="absolute left-[58px] top-8 hidden h-px w-[calc(100%+24px)] bg-slate-200 lg:block" />
                )}

                <div className="relative z-10 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-300 sm:p-7 hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-50 sm:h-14 sm:w-14">
                    <Icon className="text-xl text-blue-600 sm:text-2xl" />
                  </div>

                  <span className="mt-5 inline-flex rounded-full bg-slate-100 px-3 py-1 text-[11px] font-bold tracking-wide text-slate-500">
                    STEP {index + 1}
                  </span>
