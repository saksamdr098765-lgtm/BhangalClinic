...
Thank you.`;
  ...
  return (
    <section className="relative overflow-hidden bg-white pt-20 pb-14 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-24">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-sky-50 via-white to-cyan-50" />
      <div className="absolute inset-0 opacity-[0.04] [background-image:radial-gradient(#0284c7_1px,transparent_1px)] [background-size:22px_22px]" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-6">
        <div className="grid gap-14 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
          ...
          <div>
            ...
            {/* Heading */}
            <h1 className="mt-4 text-4xl font-black leading-[1] tracking-tight text-slate-900 sm:text-5xl lg:text-7xl">
              {pkg.name}
            </h1>
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <TrackedWhatsappLink
                ...
                tracking={`packagePage-${pkg.name}`}
                className="group inline-flex items-center justify-center gap-3 rounded-2xl bg-gradient-to-r from-sky-600 to-cyan-600 px-8 py-4 font-semibold text-white shadow-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
              >
                Book This Package
              ...
              <TrackedPhoneLink
                ...
                tracking="packagePage"
                className="inline-flex items-center justify-center rounded-2xl border border-sky-200 bg-white px-8 py-4 font-semibold text-slate-700 transition hover:border-sky-500 hover:bg-sky-50"
              >
                Free Consultation
              </TrackedPhoneLink>
            </div>
            ...
            <div className="rounded-[36px] border border-sky-100 bg-white p-6 shadow-[0_25px_60px_rgba(14,165,233,.12)] lg:p-8">
              ...
              <div className="mt-8 grid gap-4">
                {[
                  ...
                  <div
                    key={item.title}
                    className="flex items-center gap-4 rounded-2xl border border-slate-100 bg-slate-50 p-4 transition hover:border-sky-200 hover:bg-white"
                  >
                    <div
