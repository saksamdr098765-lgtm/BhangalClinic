  ...
  return (
    <section className="relative overflow-hidden bg-slate-50 py-14 sm:py-20 lg:py-24">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl lg:rounded-[40px]">
          <div className="grid lg:grid-cols-[1.1fr_.9fr]">
            {/* LEFT */}
            <div className="p-6 sm:p-8 lg:p-12">
              <span className="inline-flex rounded-full bg-blue-50 px-4 py-2 text-xs font-semibold text-blue-700 sm:text-sm">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <TrackedWhatsappLink
                  ...
                  tracking={`packagePage-CTA-${pkg.name}`}
                  className="group inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 py-4 font-semibold text-white transition-all duration-300 hover:bg-blue-700 hover:-translate-y-1"
                >
                  Book This Package
                ...
                <TrackedPhoneLink
                  ...
                  tracking="packagePage-CTA"
                  className="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-6 py-4 font-semibold text-slate-700 transition duration-300 hover:border-blue-300 hover:bg-blue-50"
                >
                  Contact Us
                </TrackedPhoneLink>
              </div>
            ...
            {/* RIGHT */}
            <div className="border-t border-slate-200 bg-slate-50 p-6 sm:p-8 lg:border-l lg:border-t-0 lg:p-12">
