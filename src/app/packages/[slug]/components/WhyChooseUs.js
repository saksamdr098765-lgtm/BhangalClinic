      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div>
            ...
            <h2 className="mt-6 text-4xl font-black leading-tight tracking-tight text-slate-900 lg:text-5xl">
          ...
          <div className="space-y-5">
            {reasons.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg"
                >
