        ...
        <div className="mt-10 space-y-3 sm:mt-14 sm:space-y-4">
          {faqs.map((item, index) => {
            ...
            return (
              <div
                key={item.question}
                className="overflow-hidden rounded-2xl border border-slate-200 bg-white sm:rounded-[24px]"
              >
                <button
                  type="button"
                ...
                >
                  <h3 className="pr-2 text-sm font-semibold leading-6 text-slate-900 sm:text-lg">
                    {item.question}
                  </h3>
                ...
                {isOpen && (
                  <div className="border-t border-slate-100 px-4 pb-5 pt-4 sm:px-6 sm:pb-6 sm:pt-5">
