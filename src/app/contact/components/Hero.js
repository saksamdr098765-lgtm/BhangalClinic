        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.2fr_.8fr] lg:gap-20">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <TrackedLink
                href="#booking"
                tracking="contactPage-booking"
                className="inline-flex items-center justify-center gap-3 rounded-2xl bg-blue-600 px-7 py-4 font-semibold text-white transition duration-300 hover:-translate-y-1 hover:bg-blue-500 hover:shadow-xl"
              >
                Book Appointment
                <FiArrowRight />
              </TrackedLink>
              ...
              <TrackedPhoneLink
                ...
                tracking="contactPage"
                className="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-7 py-4 font-semibold text-slate-700 transition duration-300 hover:border-blue-300 hover:bg-blue-50"
              >
                Call Laboratory
              </TrackedPhoneLink>
            </div>
