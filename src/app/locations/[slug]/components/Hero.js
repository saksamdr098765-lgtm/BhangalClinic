        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_430px] lg:gap-12">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:mt-10 sm:flex-row">
              ...
              <TrackedLink
                href="/contact"
                tracking={`location-hero-contact-${location.city}`}
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 sm:mt-10 sm:grid-cols-4 sm:gap-4">
              <div className="rounded-xl bg-white/10 p-4 backdrop-blur sm:rounded-2xl sm:p-5">
                ...
                <p className="mt-2 text-xl font-black text-white sm:text-2xl">500+</p>
                <p className="mt-1 text-xs text-sky-100 sm:text-sm">Lab Tests</p>
              </div>

              <div className="rounded-xl bg-white/10 p-4 backdrop-blur sm:rounded-2xl sm:p-5">
                <FiShield className="h-6 w-6 text-cyan-300 sm:h-7 sm:w-7" />
                <p className="mt-2 text-xl font-black text-white sm:text-2xl">100%</p>
                <p className="mt-1 text-xs text-sky-100 sm:text-sm">Accurate Reports</p>
              </div>
              ...
              <div className="rounded-xl bg-white/10 p-4 backdrop-blur sm:rounded-2xl sm:p-5">
                ...
                <p className="mt-1 text-xs text-sky-100 sm:text-sm">Service Area</p>
              </div>

              <div className="rounded-xl bg-white/10 p-4 backdrop-blur sm:rounded-2xl sm:p-5">
                <FiHome className="h-6 w-6 text-cyan-300 sm:h-7 sm:w-7" />
                <p className="mt-2 text-lg font-black text-white sm:text-xl">Home</p>
                <p className="mt-1 text-xs text-sky-100 sm:text-sm">Collection</p>
              </div>
            </div>
          </div>
