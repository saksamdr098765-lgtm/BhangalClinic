        ...
        >
          ...
          <div className="relative flex h-full flex-col">
            ...
            <div className="mt-auto flex items-center justify-between pt-6">
              ...
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white shadow transition group-hover:bg-blue-600">
                <FiArrowRight className="text-slate-600 transition group-hover:translate-x-1 group-hover:text-white" />
              </div>
