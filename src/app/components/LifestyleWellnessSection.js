      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14">
          <TrackedLink
            ...
            tracking={`LifestyleWellness-${featured.slug}`}
            className="group relative flex flex-col overflow-hidden rounded-[36px] bg-gradient-to-r from-sky-600 via-blue-600 to-indigo-700 p-8 text-white shadow-2xl lg:flex-row lg:items-center lg:justify-between lg:p-14 transition-all duration-300 hover:shadow-[0_30px_90px_rgba(37,99,235,0.3)]"
          >
            <div className="max-w-xl">
              ...
              <div className="mt-8 inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 font-semibold text-blue-700 transition duration-300 group-hover:gap-4">
                Explore Packages
          ...
          {categories.map((item) => (
            <div key={item.slug}>
              <TrackedLink
                ...
                tracking={`LifestyleWellness-${item.slug}`}
