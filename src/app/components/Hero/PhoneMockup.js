    ...
    >
      ...
      >
        ...
        <div className="relative h-[680px] w-[340px] rounded-[48px] bg-slate-950 p-[10px] shadow-[0_40px_80px_rgba(15,23,42,.25)]">
          ...
          <div className="h-full overflow-hidden rounded-[40px] bg-white">
            ...
            <div className="absolute bottom-8 left-6 right-6">
              ...
              <button className="w-full rounded-2xl bg-slate-900 py-4 font-semibold text-white transition hover:bg-blue-600">
                Continue Booking
              </button>
        ...
        <motion.div
          ...
          className="absolute -left-24 top-24 rounded-2xl border border-white bg-white px-5 py-4 shadow-xl"
        >
          <p className="text-xs text-slate-500">
            Booking Status
          </p>
