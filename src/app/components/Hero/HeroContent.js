    ...
    <div className="w-full max-w-2xl">
      ...
      <div className="mt-7 flex flex-col gap-3 sm:flex-row">
        <TrackedLink
          ...
          className="group flex items-center justify-center gap-3 rounded-full bg-blue-700 px-8 py-4 font-semibold text-white shadow-lg shadow-blue-700/20 transition hover:-translate-y-1"
        >
          Book Health Test
        ...
        <TrackedLink
          ...
          className="rounded-full border border-slate-200 bg-white px-8 py-4 text-center font-semibold text-slate-700 transition hover:border-teal-300 hover:bg-teal-50"
        >
          Explore Packages
        </TrackedLink>
      </div>
      ...
      <div className="mt-10 grid gap-3 sm:grid-cols-3">
        {trustItems.map((item) => {
          ...
          return (
            <div
              key={item.title}
              className="flex items-center gap-3 rounded-3xl border border-slate-100 bg-white p-4 shadow-sm transition hover:shadow-md"
            >
              <div
